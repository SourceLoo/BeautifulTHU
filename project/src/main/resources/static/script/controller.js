...
//                                  '<li class="weui-media-box__info__meta weui-media-box__info__meta_extra"><a href="/student/question/?question_id='+q.question_id+'">'详情>>'</a></li>' +
//                                  '</ul>' +
//                                  '</div>'
//                    }
//                    // 为了测试，延迟1秒加载
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for(var i = 0; i < data.question_list.length; i++) {
                        ...
                        q.like_num + '</li>' +
                        '<li class="weui-media-box__info__meta weui-media-box__info__meta_extra"><a href="/student/home/question/?question_id='+q.question_id+'" style="color: #990099">详情</a></li>' +
